...
function DefaultMenu(props) {
    return (
        <div id="default-menu" className={(props.active ? " block " : " hidden ") + " cursor-default w-52 text-left py-2 absolute z-50 text-xs font-mono"} style={{ backgroundColor: '#141414', border: '1px solid #242424' }}>
