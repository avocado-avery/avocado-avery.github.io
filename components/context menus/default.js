...
function DefaultMenu(props) {
    return (
        <div id="default-menu" className={(props.active ? " block " : " hidden ") + " context-menu-bg cursor-default w-52 text-left py-2 absolute z-50 text-xs font-mono"}>
            ...
            <Devider />
            <a rel="noreferrer noopener" href="https://itsavery.me/linkedin" target="_blank" className="w-full block cursor-default py-1 hover:bg-white hover:bg-opacity-5 mb-0.5">
                <span className="ml-4 text-ubt-blue">&gt;</span> <span className="ml-2 text-ubt-grey">Follow on <strong>LinkedIn</strong></span>
            </a>
            <a rel="noreferrer noopener" href="https://itsavery.me/github" target="_blank" className="w-full block cursor-default py-1 hover:bg-white hover:bg-opacity-5 mb-0.5">
