...
function DesktopMenu(props) {
    ...
    return (
        <div id="desktop-menu" className={(props.active ? " block " : " hidden ") + " cursor-default w-52 text-left py-2 absolute z-50 text-xs font-mono"} style={{ backgroundColor: '#141414', border: '1px solid #242424' }}>
...
function Devider() {
    return (
        <div className="flex justify-center w-full">
            <div className="w-4/5 my-1" style={{ borderTop: '1px solid #242424' }}></div>
        </div>
    );
}
